...
abstract class $FavoritesStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, List<Meal> meals, String? error});
}
...
class _$FavoritesStateImpl implements _FavoritesState {
  const _$FavoritesStateImpl(
      {this.isLoading = false, final List<Meal> meals = const [], this.error})
      : _meals = meals;
  ...
  @override
  String toString() {
    return 'FavoritesState(isLoading: $isLoading, meals: $meals, error: $error)';
  }
